                            ...
                            >
                                ...
                                <ul className="space-y-3 sm:space-y-5">
                                    ...
                                    >
                                        ...
                                        <span className={`text-[10px] sm:text-sm leading-relaxed font-medium transition-colors ${isDark ? 'text-black hover:text-[#47C4B7]' : 'text-gray-400 hover:text-white'}`}>+91 7875335539</span>
                                    </motion.li>
                                    <motion.li 
                                        whileHover={{ x: 5 }}
                                        whileTap={{ scale: 0.98, x: 7 }}
                                    ...
                                    >
                                        ...
                                        <span className={`text-[10px] sm:text-sm leading-relaxed font-medium transition-colors ${isDark ? 'text-black hover:text-[#47C4B7]' : 'text-gray-400 hover:text-white'}`}>gauravpatil@gmail.com</span>
                                    </motion.li>
                                </ul>
                            </motion.div>
                        </div>
